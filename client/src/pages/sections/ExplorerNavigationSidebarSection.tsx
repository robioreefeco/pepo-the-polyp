...
import { MetaMaskIcon, CopyIcon, PlusIcon, WalletIcon, TelegramPlaneIcon } from "@/components/icons";
...
const TelegramIcon = ({ muted }: { muted?: boolean }) => <TelegramPlaneIcon size={20} muted={muted} />;
